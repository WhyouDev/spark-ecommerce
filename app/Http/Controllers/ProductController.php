    ...
    public function productjson(){
        ...
        return Datatables::of($productlist)
         ->addColumn('action', function ($productlist) {
                $btn = '<center><a href="javascript:void(0)" data-toggle="tooltip"  data-id="'.$productlist->products_id.'" data-original-title="Edit" class="edit btn btn-primary btn-sm editProduct"><i class="fa fa-edit"></i>&nbspEdit</a>';
